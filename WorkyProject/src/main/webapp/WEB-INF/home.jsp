	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				...
				<hr/>
				<ul class="list-inline">
					<li><a href="/selectCate/1"><img src="images/11.png" alt="icon" title="icon" class="img-fluid" /> <p> Programming </p></a></li>
					<li><a href="/selectCate/2"><img src="images/22.png" alt="icon" title="icon" class="img-fluid" /><p> Accounting & Finance </p></a></li>
					<li><a href="/selectCate/3"><img src="images/33.png" alt="icon" title="icon" class="img-fluid" /><p> Project Management</p></a></li>
					<li><a href="/selectCate/4"><img src="images/44.png" alt="icon" title="icon" class="img-fluid" /><p> Writing & Copywriting </p></a></li>
					<li><a href="/selectCate/5"><img src="images/55.png" alt="icon" title="icon" class="img-fluid" /><p> Education & Training </p></a></li>
					<li><a href="/selectCate/6"><img src="images/66.png" alt="icon" title="icon" class="img-fluid" /><p> Graphic Design </p></a></li>
					<li><a href="/selectCate/7"><img src="images/77.png" alt="icon" title="icon" class="img-fluid" /><p> Marketing </p></a></li>
					<li><a href="/selectCate/8"><img src="images/88.png" alt="icon" title="icon" class="img-fluid" /><p> Translation </p></a></li>
					<li><a href="/selectCate/9"><img src="images/99.png" alt="icon" title="icon" class="img-fluid" /><p> Photography </p></a></li>
					<li><a href="/selectCate/10"><img src="images/a1.png" alt="icon" title="icon" class="img-fluid" /><p> 3D Modeling & CAD </p></a></li>
					<li><a href="/selectCate/11"><img src="images/a2.png" alt="icon" title="icon" class="img-fluid" /><p>Structural Engineering</p></a></li>
					<li><a href="/selectCate/12"><img src="images/a3.png" alt="icon" title="icon" class="img-fluid" /><p>Mechanical Engineering</p></a></li>
					<li><a href="/selectCate/13"><img src="images/a4.png" alt="icon" title="icon" class="img-fluid" /><p> Architectural Engineering </p></a></li>
					<li><a href="/selectCate/14"><img src="images/a5.png" alt="icon" title="icon" class="img-fluid" /><p> Building Work </p></a></li>
					<li><a href="/selectCate/15"><img src="images/a6.png" alt="icon" title="icon" class="img-fluid" /><p> Employees & Worker </p></a></li>
					<li><a href="/selectCate/16"><img src="images/a7.png" alt="icon" title="icon" class="img-fluid" /><p> Handicrafts </p></a></li>
					<li><a href="/selectCate/17"><img src="images/a8.png" alt="icon" title="icon" class="img-fluid" /><p> Data Entry </p></a></li>
					<li><a href="/selectCate/18"><img src="images/a9.png" alt="icon" title="icon" class="img-fluid" /><p> Other </p></a></li>
