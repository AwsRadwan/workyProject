                        ...
                        <div class="col-sm-9 col-xs-12 padd0">
                            ...
                            <ul class="list-inline">
                                <li><a href="/profile"><img src="images/dashboard/grid.png"
                                    ...
                                    <p>Dashboard</p></a></li>
                                <li class="active"><a href="/dashboardmyservices"><img src="images/dashboard/card.png"
                                                                                       alt="image"
                                                                                       title="image"/>
                                ...
                                <div class="product-thumb">
                                    ...
                                    <div class="caption">
                                        ...
                                        <div class="button-group text-center visible-xs">
                                            ...
                                            <button onclick="doView(${service.id})" type="button"><i
                                                    class="la la-eye"></i></button>
                                            <button onclick="doEdit(${service.id})" type="button"><i
                                                    class="la la-pencil"></i>
                                            </button>
                                            <button onclick="doDelete(${service.id})" type="button"><i
                                                    class="la la-trash"></i>
                                            </button>
                                        </div>
                                    </div>
