                ...
                <div class="left">
                    <div class="category">
                        ...
                        <ul class="list-unstyled">
                            <c:forEach items="${categories}" var="c">
                                <li><a href="/selectCate/${c.id}"><img src="/images/blog/${c.img}.png" class="img-fluid"
                                                                       alt="image" title="image"> <c:out
                                        value="${c.name}"></c:out> </a></li>
                            </c:forEach>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="product-layout product-grid col-lg-3 col-md-4 col-sm-6 col-xs-12 cols">
                            <div class="product-thumb">
                                ...
                                <div class="caption">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><i class="la la-map-marker"></i> <c:out value="${s.creator.city}"></c:out>
                                        </li>
                                        <li><i class="la la-clock-o"></i> <c:out
                                                value="${s.createdAt.toString() }"></c:out></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
